...
def init_vector_db(
    file_paths: list[str], cohere_api_key: str, output_file_name: str = "combined_index"
):
    try:
        print("- 🕞 Creating FAISS Vector DB from multiple files...")
        ...
        output_path = f"vector_db/{output_file_name}"
        vectorstore.save_local(output_path)

        print(f"- ✅ FAISS vector DB created at: {output_path}")
